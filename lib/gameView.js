(function(){
  ...
  GameView.prototype.start = function(){
    ...
    var gameUpdate = function(){
      ...
      if (that.game.checkOver(that.ctx)){
        window.clearInterval(int);
      }
    }

    var int = window.setInterval(gameUpdate, 20);
    ...
    window.setInterval(function(){
      ...
      if(keys.indexOf(87) !== -1 && keys.indexOf(65) !== -1){
        ...
        that.game.ship.moveForward();
      } else if (keys.indexOf(83) !== -1 && keys.indexOf(68) !== -1){
        that.game.ship.moveLeft();
        that.game.ship.moveBackward();
      } else if (keys.indexOf(83) !== -1 && keys.indexOf(65) !== -1){
        that.game.ship.moveRight();
        that.game.ship.moveBackward();
    ...
    key('r', function(){
      that.game.restart();
      int = window.setInterval(gameUpdate, 20);
    });
  };
